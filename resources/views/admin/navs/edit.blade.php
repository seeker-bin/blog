...
<div class="result_wrap">
    <form action="{{url('admin/navs/'.$info->nav_id)}}" method="post">
        {{method_field('PUT')}}
        {{csrf_field()}}
        <table class="add_tab">
            <tbody>
            <tr>
                ...
                <td>
                    <input type="text" name="nav_name" value="{{$info->nav_name}}">
                    <input type="text" name="nav_alias" class="sm" value="{{$info->nav_alias}}">
            ...
            <tr>
                ...
                <td>
                    <input type="text" class="lg" name="nav_url" value="{{$info->nav_url}}">
                </td>
            </tr>
            <tr>
                <th>排序：</th>
                <td>
                    <input type="text" class="sm" name="nav_order" value="{{$info->nav_order}}">
                </td>
            </tr>
            <tr>
                <th></th>
