    ...
    <form action="{{url('admin/category/'.$info->cate_id)}}" method="post">
        ...
        <table class="add_tab">
            ...
            <tr>
                ...
                <td>
                    <select name="cate_pid">
                        ...
                        @foreach($first_cate as $d)
                            <option @if($d->cate_id == $info->cate_pid) selected @endif value="{{$d->cate_id}}">{{$d->cate_name}}</option>
                        @endforeach
                    </select>
                </td>
            </tr>
            ...
            <tr>
                <th>URL：</th>
                <td>
                    <input type="text" class="lg" name="cate_url" value="{{$info->cate_url}}">
                </td>
            </tr>
            <tr>
                <th>关键词：</th>
                <td>
                    <textarea name="cate_keywords">{{$info->cate_keywords}}</textarea>
                </td>
            </tr>
            <tr>
                <th>描述：</th>
