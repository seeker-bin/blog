        ...
        <ul>
            ...
            <li>
                ...
                <ul class="sub_menu" style="display: block;">
                    ...
                    <li><a href="{{url('admin/joke')}}" target="main"><i class="fa fa-fw fa-list-ul"></i>笑话列表</a></li>
                </ul>
            </li>
            <li>
                ...
                <ul class="sub_menu" style="display: block;">
                    ...
                    <li><a href="{{url('admin/config')}}" target="main"><i class="fa fa-fw fa-gears"></i>网站配置</a></li>
