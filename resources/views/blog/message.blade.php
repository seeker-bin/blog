...
<section class="container">
	<div class="page_left">
		<ul>
			<li><a href="{{url('about/me')}}">关于作者</a></li>
			<li><a href="{{url('message/me')}}" class="cur" >留言联系</a></li>
		</ul>
	</div>
	<div class="page_right">
	   	<h1 class="page_title">留言联系</h1>   
	   	<div class="page_content">
			<form action="{{url('message/send')}}" method="post" name="guest" onsubmit="return check()">
				{{csrf_field()}}
				...
				<tr>
					<td>验证码</td>
					<td><input name="code" type="text" class='input_text' style="width:100px;margin:5px 10px 10px 0;"><img src="{{url('code/mcode')}}" onclick="this.src='{{url('code/mcode')}}'+Math.random()" style="cursor:pointer;" title="看不清？点击更换"><span class='xing'>*</span></td>
				</tr>		
				<tr>
					<td></td>
