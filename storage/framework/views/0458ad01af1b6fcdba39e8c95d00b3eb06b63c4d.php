            ...
            <div class="result_content">
                <table class="list_tab">
                    ...
                    <?php $__currentLoopData = $article; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td class="tc"><?php echo e($v->aid); ?></td>
                            <td><a href="#"><?php echo e($v->title); ?></a></td>
                            <td class="tc"><?php echo e($v->view); ?></td>
                            <td class="tc"><?php echo e($v->author); ?></td>
                            <td class="tc"><?php echo e(date('Y-m-d H:i:s', $v->add_time)); ?></td>
                            <td class="tc">
                                <a style="float: none;" href="<?php echo e(url('admin/article/'.$v->aid.'/edit')); ?>">修改</a>
                                <a style="float: none;" href="javascript:;" onclick="delArticle(<?php echo e($v->aid); ?>)">删除</a>
                            </td>
                        </tr>
...
<script>
    ...
    function delArticle(aid){
        layer.confirm('确定要删除该文章吗？', {
            ...
            var URL = '<?php echo e(url('admin/article')); ?>/' + aid;
