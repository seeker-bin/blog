...
<div class="crumb_warp">
    ...
    <i class="fa fa-home"></i> <a href="<?php echo e(url('admin/info')); ?>">首页</a> &raquo; <a href="<?php echo e(url('admin/article')); ?>">文章管理</a> &raquo; 编辑文章
</div>
<!--面包屑导航 结束-->
...
<div class="result_wrap">
    <form action="<?php echo e(url('admin/article/'.$info->aid)); ?>" method="post">
        ...
        <table class="add_tab">
                ...
                <td>
                    <select name="cate_id">
                        ...
                        <?php $__currentLoopData = $category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option <?php if($d->cate_id == $info->cate_id): ?> selected <?php endif; ?> value="<?php echo e($d->cate_id); ?>"><?php echo e($d->_cate_name); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </td>
            </tr>
            <tr>
                <th>文章标题：</th>
                <td>
                    <input type="text" class="lg" name="title" value="<?php echo e($info->title); ?>">
                </td>
            </tr>
            <tr>
                <th>作者：</th>
                <td>
                    <input type="text" class="sm" name="author" value="<?php echo e($info->author); ?>">
                </td>
            </tr>
            <tr>
                <th>缩略图：</th>
                <td>
                    <input type="text" size="50" name="thumb" value="<?php echo e($info->thumb); ?>">
            ...
            <tr>
                <th></th>
                <td>
                    <img src="<?php echo e($info->thumb); ?>" alt="" id="thumb_img" style="max-width: 350px;max-height: 150px;">
                </td>
            </tr>
            <tr>
                <th>关键词：</th>
                <td>
                    <input type="text" class="lg" name="tag" value="<?php echo e($info->tag); ?>">
                </td>
            </tr>
            <tr>
                <th>描述：</th>
            ...
            <tr>
                <th>是否推荐：</th>
                <td>
                    是<input type="radio" name="is_top" value="1" <?php if($info->is_top == 1): ?> checked <?php endif; ?>>
                    否<input type="radio" name="is_top" value="0" <?php if($info->is_top == 0): ?> checked <?php endif; ?>>
                </td>
            </tr>
            <tr>
                <th>文章内容：</th>
