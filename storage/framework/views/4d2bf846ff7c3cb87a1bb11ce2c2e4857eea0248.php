...
<head>
    ...
    <link rel="stylesheet" id="open_social_css-css" href="<?php echo e(asset('css/blog-os.css')); ?>" type="text/css" media="all" />
    <link rel="stylesheet" href="<?php echo e(asset('css/blog-style.css')); ?>" media="all">
  <link rel="stylesheet" href="<?php echo e(asset('css/blog-swiper.min.css')); ?>" media="all">
  <link href="<?php echo e(asset('css/blog-font-awesome.min.css')); ?>" rel="stylesheet" media="screen">
  <script type="text/javascript" src="<?php echo e(asset('js/blog-base.loading.js')); ?>"></script>  
</head>
  
<body class="home blog">
<div class="placeholder"></div>   
<!--[if lt IE 9]>
  <script src="<?php echo e(asset('js/blog-html5.js')); ?>"></script>
<![endif]-->
<script src="<?php echo e(asset('js/blog-jquery.js')); ?>"></script>
<script>
  window._deel = {
  maillist: '',
  maillistCode: '',
