...
<div class="result_wrap">
    <form action="<?php echo e(url('admin/category/'.$info->cate_id)); ?>" method="post">
        ...
        <table class="add_tab">
                ...
                <td>
                    <select name="cate_pid">
                        ...
                        <?php $__currentLoopData = $first_cate; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option <?php if($d->cate_id == $info->cate_pid): ?> selected <?php endif; ?> value="<?php echo e($d->cate_id); ?>"><?php echo e($d->cate_name); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <input type="text" name="cate_name" value="<?php echo e($info->cate_name); ?>">
            ...
            <tr>
                <th>分类标题：</th>
                <td>
                    <input type="text" class="lg" name="cate_title" value="<?php echo e($info->cate_title); ?>">
                </td>
            </tr>
            <tr>
                <th>URL：</th>
            ...
            <tr>
                <th>描述：</th>
                <td>
                    <textarea name="cate_description"><?php echo e($info->cate_description); ?></textarea>
                </td>
            </tr>
            <tr>
                <th><i class="require">*</i>排序：</th>
                <td>
                    <input type="text" class="sm" name="cate_order" value="<?php echo e($info->cate_order); ?>">
                </td>
            </tr>
            <tr>
                <th></th>
