...
<div class="crumb_warp">
    ...
    <i class="fa fa-home"></i> <a href="<?php echo e(url('admin/info')); ?>">首页</a> &raquo; <a href="<?php echo e(url('admin/navs')); ?>">自定义导航管理</a> &raquo; 添加自定义导航
</div>
<!--面包屑导航 结束-->
...
<div class="result_wrap">
    <form action="<?php echo e(url('admin/navs')); ?>" method="post">
