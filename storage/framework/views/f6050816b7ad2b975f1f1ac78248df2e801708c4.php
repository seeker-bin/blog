		           	...
		           	<div class="comment_box">
						...
						<div class="com_form">
							...
							<p>
								...
								<span class="yzm">
								<img src="<?php echo e(url('code/ccode')); ?>" onclick="this.src='<?php echo e(url('code/ccode')); ?>?'+Math.random()" class="codeimg" title="看不清，换一张"><input type="text" name="code" required="required"></span></p>
						   </form>
						</div>
						</div>
								     				...
								     				<div id="rep_<?php echo e($v->id); ?>" class="none">
								     					<form action="<?php echo e(url('Comment')); ?>" method="post"  onsubmit="return check_rep(this)">
															...
															<p>
																...
																<span class="yzm yzm2">
																<img src="<?php echo e(url('code/ccode')); ?>" onclick="this.src='<?php echo e(url('code/ccode')); ?>?'+Math.random()" class="codeimg" title="看不清，换一张"><input type="text" name="code" required="required"></span>
															</p>
								     					</form>
								     				</div>
								     			</div>
